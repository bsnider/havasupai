import{vm as ae,F$ as _,G0 as ie,G1 as se,Es as ne,Fb as oe,Eq as ce,aM as r,G2 as le,G3 as pe,Ex as n,FT as de,xO as J,F7 as he,FS as ve,Ew as E,G4 as ue,Et as me,Ev as fe,Ey as Se,Fz as Te,EA as ge,G5 as G,G6 as Pe,G7 as Ee,Fc as _e,EB as Ae,EC as Oe,_ as we,EE as D,EG as j,EH as ye,EI as B,EJ as L,Fd as Re,EL as $e,EM as xe,FA as ze,EK as Ce,EQ as U,G8 as De,G9 as V,Ga as H,Gb as Ie,Gc as Le,Gd as be,pF as f,dg as Ue,Ge as Me,EV as b,Ff as Ne,Gf as Z,tD as Y,aC as I,sR as K,rU as ke,df as We,FK as Fe,Gg as Ge,EY as je,aG as q,aH as X,wG as Be,j8 as Q,Gh as Ve}from"./index-Ds3x37R4.js";function ee(o){const e=new ae,{space:t,anchor:c,hasTip:S}=o,h=t===_.World;e.include(ie,o),e.include(se,o),e.include(ne,o);const{vertex:a,fragment:p,varyings:T}=e;p.include(oe),ce(a,o),e.attributes.add(r.POSITION,"vec3"),e.attributes.add(r.PREVIOUSDELTA,"vec4"),e.attributes.add(r.UV0,"vec2"),T.add("vColor","vec4"),T.add("vpos","vec3",{invariant:!0}),T.add("vUV","vec2"),T.add("vSize","float"),S&&T.add("vLineWidth","float"),a.uniforms.add(new le("nearFar",(({camera:d})=>d.nearFar)),new pe("viewport",(({camera:d})=>d.fullViewport))).code.add(n`vec4 projectAndScale(vec4 pos) {
...
return abs(cos) > 0.001 && t > 0.0;
  ...
  `)),ue(a),a.main.add(n`
    ...
    }`),p.include(me,o),e.include(fe,o),p.include(Se),p.uniforms.add(new Te("intrinsicColor",(({color:d})=>d)),new ge("tex",(({markerTexture:d})=>d))).constants.add("texelSize","float",1/G).code.add(n`float markerAlpha(vec2 samplePos) {
samplePos += vec2(0.5, -0.5) * texelSize;
float sdf = rgbaTofloat(texture(tex, samplePos)) - 0.5;
float distance = sdf * vSize;
distance -= 0.5;
return clamp(0.5 - distance, 0.0, 1.0);
}`),S&&p.constants.add("relativeMarkerSize","float",Pe/G).constants.add("relativeTipLineWidth","float",Ee).code.add(n`
