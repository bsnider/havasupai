import{GG as Pe,GD as ve,H7 as be,Ez as _,FU as w,GI as Ee,EA as F,Ex as r,dz as j,vm as te,GF as De,Fz as A,vR as we,j8 as v,eX as ie,aH as h,ei as R,e_ as G,H8 as Ve,na as ne,FS as se,F9 as T,e$ as b,H9 as ae,b3 as re,b4 as le,eZ as xe,eW as Se,n9 as ye,lx as Le,fg as Ce,eh as Ae,aI as oe,EB as ce,EC as he,_ as de,Ep as Te,dh as B,f8 as z,GE as Me,rJ as $e,h6 as Re,F7 as Ue,G2 as Oe,aM as o,Ew as X,aN as Ie,aG as O,l9 as qe,df as pe,a$ as N,vK as ze,hz as Ne,E as je,l7 as He,Ha as We,r as g,ET as x,GM as Fe,GN as k,Hb as Ge,Hc as Be,me as Xe,GO as c,Hd as U,He as ke,s7 as Z,fa as Ze,fc as Je,tU as Ke,fd as Ye,fe as Qe,ff as et,m as M,d as tt,Hf as it,h3 as J}from"./index-Ds3x37R4.js";import{t as nt}from"./VisualElement-DitvOpDw.js";function ue(t,e){const n=t.fragment;n.include(Pe),t.include(ve),n.include(be),n.uniforms.add(new _("globalAlpha",(i=>i.globalAlpha)),new w("glowColor",(i=>i.glowColor)),new _("glowWidth",((i,s)=>i.glowWidth*s.camera.pixelRatio)),new _("glowFalloff",(i=>i.glowFalloff)),new w("innerColor",(i=>i.innerColor)),new _("innerWidth",((i,s)=>i.innerWidth*s.camera.pixelRatio)),new Ee("depthMap",(i=>{var s;return(s=i.depth)==null?void 0:s.attachment})),new F("normalMap",(i=>i.normals))),n.code.add(r`vec4 premultipliedColor(vec3 rgb, float alpha) {
...
return true;
}`),e.contrastControlEnabled?n.uniforms.add(new F("frameColor",((i,s)=>i.colors)),new _("globalAlphaContrastBoost",(i=>i.globalAlphaContrastBoost))).code.add(r`float rgbToLuminance(vec3 color) {
...
}`)}const H=j(6);function fe(t){const e=new te;e.include(De),e.include(ue,t);const n=e.fragment;if(t.lineVerticalPlaneEnabled||t.heightManifoldEnabled)if(n.uniforms.add(new _("maxPixelDistance",((i,s)=>t.heightManifoldEnabled?2*s.camera.computeScreenPixelSizeAt(i.heightManifoldTarget):2*s.camera.computeScreenPixelSizeAt(i.lineVerticalPlaneSegment.origin)))),n.code.add(r`float planeDistancePixels(vec4 plane, vec3 pos) {
float dist = dot(plane.xyz, pos) + plane.w;
float width = fwidth(dist);
dist /= min(width, maxPixelDistance);
return abs(dist);
}`),t.spherical){const i=(a,l,d)=>v(a,l.heightManifoldTarget,d.camera.viewMatrix),s=(a,l)=>v(a,[0,0,0],l.camera.viewMatrix);n.uniforms.add(new A("heightManifoldOrigin",((a,l)=>(i(f,a,l),s(V,l),ie(V,V,f),R(u,V),u[3]=G(V),u))),new Ve("globalOrigin",(a=>s(f,a))),new _("cosSphericalAngleThreshold",((a,l)=>1-Math.max(2,ne(l.camera.eye,a.heightManifoldTarget)*l.camera.perRenderPixelRatio)/G(a.heightManifoldTarget)))),n.code.add(r`float globeDistancePixels(float posInGlobalOriginLength) {
...
vec4 color = vec4(0.0);`),t.heightManifoldEnabled){n.uniforms.add(new T("angleCutoff",(s=>$(s))),new A("heightPlane",((s,a)=>ge(s.heightManifoldTarget,s.renderCoordsHelper.worldUpAtPosition(s.heightManifoldTarget,f),a.camera.viewMatrix))));const i=t.spherical?r`normalize(globalOrigin - pos)`:r`heightPlane.xyz`;n.main.add(r`
      ...
      color = max(color, heightManifoldColor * heightManifoldAlpha);`)}return t.pointDistanceEnabled&&(n.uniforms.add(new T("angleCutoff",(i=>$(i))),new A("pointDistanceSphere",((i,s)=>st(i,s)))),n.main.add(r`float pointDistanceSphereDistance = sphereDistancePixels(pointDistanceSphere, pos);
vec4 pointDistanceSphereColor = laserlineProfile(pointDistanceSphereDistance);
float pointDistanceSphereAlpha = 1.0 - smoothstep(angleCutoff.x, angleCutoff.y, abs(dot(normal, normalize(pos - pointDistanceSphere.xyz))));
color = max(color, pointDistanceSphereColor * pointDistanceSphereAlpha);`)),t.lineVerticalPlaneEnabled&&(n.uniforms.add(new T("angleCutoff",(i=>$(i))),new A("lineVerticalPlane",((i,s)=>at(i,s))),new w("lineVerticalStart",((i,s)=>rt(i,s))),new w("lineVerticalEnd",((i,s)=>lt(i,s)))),n.main.add(r`if (pointIsWithinLine(pos, lineVerticalStart, lineVerticalEnd)) {
...
}`)),n.main.add(r`fragColor = laserlineOutput(color * depthDiscontinuityAlpha);`),e}function $(t){return re(ot,Math.cos(t.angleCutoff),Math.cos(Math.max(0,t.angleCutoff-j(2))))}function st(t,e){return v(Le(I),t.pointDistanceOrigin,e.camera.viewMatrix),I[3]=ne(t.pointDistanceOrigin,t.pointDistanceTarget),I}function at(t,e){const n=Ce(t.lineVerticalPlaneSegment,.5,f),i=t.renderCoordsHelper.worldUpAtPosition(n,ct),s=R(V,t.lineVerticalPlaneSegment.vector),a=Ae(f,i,s);return R(a,a),ge(t.lineVerticalPlaneSegment.origin,a,e.camera.viewMatrix)}function rt(t,e){const n=b(f,t.lineVerticalPlaneSegment.origin);return t.renderCoordsHelper.setAltitude(n,0),v(n,n,e.camera.viewMatrix)}function lt(t,e){const n=oe(f,t.lineVerticalPlaneSegment.origin,t.lineVerticalPlaneSegment.vector);return t.renderCoordsHelper.setAltitude(n,0),v(n,n,e.camera.viewMatrix)}function ge(t,e,n){return v(K,t,n),b(u,e),u[3]=0,ae(u,u,n),xe(K,u,ht)}const ot=le(),f=h(),u=we(),ct=h(),V=h(),K=h(),ht=Se(),I=ye(),dt=Object.freeze(Object.defineProperty({__proto__:null,build:fe,defaultAngleCutoff:H},Symbol.toStringTag,{value:"Module"}));let pt=class extends Te{constructor(){super(...arguments),this.innerColor=B(1,1,1),this.innerWidth=1,this.glowColor=B(1,.5,0),this.glowWidth=8,this.glowFalloff=8,this.globalAlpha=.75,this.globalAlphaContrastBoost=2,this.angleCutoff=j(6),this.pointDistanceOrigin=h(),this.pointDistanceTarget=h(),this.lineVerticalPlaneSegment=z(),this.intersectsLineSegment=z(),this.intersectsLineRadius=3,this.heightManifoldTarget=h(),this.lineStartWorld=h(),this.lineEndWorld=h()}};class ut extends ce{constructor(e,n){super(e,n,new he(dt,(()=>de(()=>Promise.resolve().then(()=>Dt),void 0))))}}function _e(t){const e=new te;e.include(ue,t);const{vertex:n,fragment:i}=e;n.uniforms.add(new Me("modelView",((a,{camera:l})=>$e(gt,l.viewMatrix,a.origin))),new Ue("proj",(({camera:a})=>a.projectionMatrix)),new _("glowWidth",((a,{camera:l})=>a.glowWidth*l.pixelRatio)),new Oe("pixelToNDC",(({camera:a})=>re(ft,2/a.fullViewport[2],2/a.fullViewport[3])))),e.attributes.add(o.START,"vec3"),e.attributes.add(o.END,"vec3"),t.spherical&&(e.attributes.add(o.START_UP,"vec3"),e.attributes.add(o.END_UP,"vec3")),e.attributes.add(o.EXTRUDE,"vec2"),e.varyings.add("uv","vec2"),e.varyings.add("vViewStart","vec3"),e.varyings.add("vViewEnd","vec3"),e.varyings.add("vViewSegmentNormal","vec3"),e.varyings.add("vViewStartNormal","vec3"),e.varyings.add("vViewEndNormal","vec3");const s=!t.spherical;return n.main.add(r`
