import{G_ as Pe,GX as ve,Hr as be,ET as _,Gc as w,H0 as De,EU as F,ER as r,d_ as N,vj as te,GZ as Ee,FT as A,vO as we,j3 as v,fm as ie,aU as h,eJ as R,fp as G,Hs as Ve,n7 as ne,Ga as se,Ft as T,fq as b,Ht as ae,bg as re,bh as le,fo as xe,fl as ye,n6 as Se,lu as Le,fH as Ce,eI as Ae,aV as oe,EV as ce,EW as he,_ as de,EJ as Te,dJ as B,fz as z,GY as Me,rG as $e,h6 as Re,Fr as Ue,Gm as Oe,aZ as o,EQ as X,a_ as Ie,aT as O,l6 as qe,dH as pe,bc as j,vH as ze,hu as je,E as Ne,l4 as He,Hu as We,r as g,Fb as x,H4 as Fe,H5 as k,Hv as Ge,Hw as Be,mb as Xe,H6 as c,Hx as U,Hy as ke,s4 as J,fB as Je,fD as Ze,tR as Ye,fE as Qe,fF as Ke,fG as et,m as M,d as tt,Hz as it,h3 as Z}from"./index-BdmtnMtL.js";import{t as nt}from"./VisualElement-C5bHlli9.js";function ue(t,e){const n=t.fragment;n.include(Pe),t.include(ve),n.include(be),n.uniforms.add(new _("globalAlpha",(i=>i.globalAlpha)),new w("glowColor",(i=>i.glowColor)),new _("glowWidth",((i,s)=>i.glowWidth*s.camera.pixelRatio)),new _("glowFalloff",(i=>i.glowFalloff)),new w("innerColor",(i=>i.innerColor)),new _("innerWidth",((i,s)=>i.innerWidth*s.camera.pixelRatio)),new De("depthMap",(i=>{var s;return(s=i.depth)==null?void 0:s.attachment})),new F("normalMap",(i=>i.normals))),n.code.add(r`vec4 premultipliedColor(vec3 rgb, float alpha) {
...
}`)}const H=N(6);function fe(t){const e=new te;e.include(Ee),e.include(ue,t);const n=e.fragment;if(t.lineVerticalPlaneEnabled||t.heightManifoldEnabled)if(n.uniforms.add(new _("maxPixelDistance",((i,s)=>t.heightManifoldEnabled?2*s.camera.computeScreenPixelSizeAt(i.heightManifoldTarget):2*s.camera.computeScreenPixelSizeAt(i.lineVerticalPlaneSegment.origin)))),n.code.add(r`float planeDistancePixels(vec4 plane, vec3 pos) {
